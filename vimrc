...
"Если нужна поддержка буфера обмена Х11 при работе в окне терминала, надо поставить пакет, скомпилированный с библиотеками для буфера обмена. Графический gVim всегда его поддерживает.
"Поддерживается ли этот буфер:
"vim --version | grep clipboard 
"Если +clipboard или +xterm_clipboard, всё в порядке.
"Если нет (т.е. - вместо +), то на Debian и Ubuntu надо поставить vim-gtk или vim-gnome.
"Если поддержка буфера обмена не нужна, поставьте vim-nox.
